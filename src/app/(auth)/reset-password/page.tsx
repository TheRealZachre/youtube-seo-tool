  ...
  if (!token) {
    return (
      <div className="text-center">
        ...
        <Link href="/forgot-password" className="mt-4 block text-sm text-sky-soft/60 hover:text-white">Request new link →</Link>
      </div>
    );
  }
    ...
    <div className="flex min-h-[100dvh] items-center justify-center bg-navy-deep px-5">
      <div className="w-full max-w-sm">
        ...
        <p className="mt-6 text-center text-xs text-white/30">
          <Link href="/login" className="hover:text-white/60">← Back to sign in</Link>
        </p>
      </div>
    </div>
  );
