    ...
    <div className="flex min-h-[100dvh] items-center justify-center bg-navy-deep px-5">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <img src="/vcf-logo-horizontal.png" alt="Vibe.Code.Flow." style={{ height: "30px", width: "auto", display: "inline-block" }} />
          <p className="mt-2 text-sm text-sky-soft/60">YouTube SEO Platform</p>
        </div>
          ...
          {sent ? (
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-sky-soft/70">
                If an account exists for that email or username, we&apos;ve sent a reset link. It expires in 1 hour.
              </p>
              {devUrl && (
                <div className="mt-4 rounded-lg bg-gold/10 p-3 text-left">
                  ...
                  <a href={devUrl} className="mt-1 block break-all text-xs text-sky-soft/80 hover:underline">{devUrl}</a>
                </div>
              )}
            ...
            <>
              ...
              <p className="mt-1 text-sm text-sky-soft/60">Enter your email or username and we&apos;ll send a reset link.</p>
